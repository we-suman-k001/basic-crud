...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-basic';
        ...
        */
        ...
        return view('basic::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.basic_version')??config('basic.version'),
            'is_dev' => config('basic.is_dev'),
        ];
